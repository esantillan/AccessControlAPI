...
|
*/
$config['allow_auth_and_keys'] = TRUE;//SEE QUEST
...
|
*/
$config['auth_library_class'] = '';//TODO
$config['auth_library_function'] = '';//TODO
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234'];//FIXME
...
|
*/
$config['rest_handle_exceptions'] = TRUE;//QUEST
...
|
*/
$config['rest_enable_keys'] = FALSE;//SEE
...
|
*/
$config['rest_key_name'] = 'Authorization';//QUEST
...
|
*/
$config['rest_ignore_http_accept'] = FALSE;//QUEST
...
|
*/
$config['allowed_cors_origins'] = [];//TODO agregar url del front
